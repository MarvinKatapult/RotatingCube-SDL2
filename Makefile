#############################################################################
# Makefile for building: rotating-cube
# Generated by qmake (3.1) (Qt 5.15.11)
# Project:  rotating-cube.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile rotating-cube.pro
#############################################################################
...
INCPATH       = -I. -Iinclude -I../../MLib/include -I/usr/include/qt -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /home/ibma/dev/sdl2-projects/RotatingCube-SDL2/debug/rotating-cube1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=4 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -L/usr/local/lib -lSDL2 /home/ibma/dev/MLib/lib/mlib.a /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		rotating-cube.pro ../../MLib/include/mmatrix.hpp \
		../../MLib/include/mlist.hpp src/main.cpp \
		../../MLib/src/mmatrix.cpp \
		../../MLib/src/mlist.cpp
...
Makefile: rotating-cube.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		rotating-cube.pro
	$(QMAKE) -o Makefile rotating-cube.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../../MLib/include/mmatrix.hpp ../../MLib/include/mlist.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp ../../MLib/src/mmatrix.cpp ../../MLib/src/mlist.cpp $(DISTDIR)/
...
debug/main.o: src/main.cpp ../../MLib/include/mmatrix.hpp \
		../../MLib/include/mlist.hpp \
		../../MLib/include/mlistelement.hpp
...
debug/mlist.o: ../../MLib/src/mlist.cpp ../../MLib/include/mlist.hpp \
		../../MLib/include/mlistelement.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o debug/mlist.o ../../MLib/src/mlist.cpp
